...
##########################################################################################
# Transformation 1 - Order the columns in a sequential order, rename few columns, and add country column
##########################################################################################
    ...
    df_india_sales_order_renamed = df_india_sales_order.rename("GST", "TAX").rename("MOBILE_NUMBER", "CONTACT_NUMBER")
    ...
    ##########################################################################################
    # Transformation 2 - Union the three data set
    ##########################################################################################
    ...
    #Fill missing values in the column Promotion Code Column
    ...
    ##########################################################################################
    # Transformation 5 - Rearranging the column in the dataframe and add insert dts column
    ##########################################################################################
